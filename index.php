            ...
            <div class="text-center">
             <?php if(!isset($_GET['idpertanyaan'])){?>
                <div class="wow bounceIn" data-wow-offset="0" data-wow-delay="0.2s">
                    ...
                    <h2><a href="http://ap-cdbr-azure-southeast-b.cloudapp.net/index.php?idpertanyaan=1#service">Mulai</a></h2>
                </div> 
            </div>
                    ...
                    <div class="wow bounceIn" data-wow-offset="0" data-wow-delay="0.9s">
                        <form class="form-inline">
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                    <a href="http://ap-cdbr-azure-southeast-b.cloudapp.net/index.php?idpertanyaan=1#service">Diagnosa Kembali</a>";
                                  <?php  
                                     } 
                                   }
                                ?>
